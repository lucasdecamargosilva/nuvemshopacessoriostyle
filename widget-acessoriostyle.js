(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=acessoriostyle';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_f5654fd05723ff0ee357510dccddcb121c971f5d4c6fbee0b547fe2053813f53";
    ...
    const ACESSORIO_STORE_WHATSAPP = '5511977991567'; // WhatsApp da loja (11) 97799-1567 — tela de limite
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://acdn-us.mitiendanube.com/stores/001/011/676/themes/common/logo-3426633271169533010-1770929933-73127744e4aa7ded6e87127b917a64861770929933-480-0.webp" alt="ACESSORIOS STYLE" style="height:48px;width:auto;filter:brightness(0);"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=acessoriostyle" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=acessoriostyle" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending && pending.qr_code_base64) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'acessoriostyle', origin: location.origin })
                    });
                    pix = await resp.json();
